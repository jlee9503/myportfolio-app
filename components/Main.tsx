...
const Main = () => {
  return (
    <section id="home-section" className="flex justify-center items-center min-h-dvh">
      ...
      <div className="z-10 flex justify-center items-center flex-col gap-5">
        ...
        <h1 className="font-extrabold text-5xl lg:text-7xl tracking-wider">Jung Lee</h1>
